...
intern constexpr s32 AUDIO_CHUNK_SIZE_MS = 200;
intern constexpr s32 WHISPER_MAX_AUDIO_CHUNK_SIZE_S = 60;
inline constexpr s32 AUDIO_SAMPLE_RATE = 16000;
inline constexpr f32 AUDIO_SILENT_THRESHOLD_RMS = 0.001f;
